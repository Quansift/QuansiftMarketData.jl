...
@testset "Sync Helper Lookups" begin
    ...
    latest_dates_lookup = TiingoJulia.Sync.build_latest_date_lookup(latest_dates_df)
    ...
    ticker_lookup = TiingoJulia.Sync.build_ticker_row_lookup(tickers)
...
@testset "Split Refresh Targets" begin
    ...
    try
        ...
        split_targets = TiingoJulia.Sync.get_split_refresh_targets(conn, Date("2024-06-10"))
